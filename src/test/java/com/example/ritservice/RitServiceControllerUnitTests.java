...
class RitServiceControllerUnitTests {
    ...
    @Test
    public void givenRit_whenDeleteRit_thenReturnStatusOk() throws Exception {
        Rit deleteRit = new Rit(15, "Startstraat 3", "Eindstraat 3", 850, "3", "3", "1-UAE-451");
    ...
    @Test
    public void givenRit_whenDeleteRit_thenReturnStatusNotFound() throws Exception {
